...
if response.status_code == 200:
    ...
    write_data('C:\Coding Folders\Pyhton_Projects\Pollution_Checker\Kolkata\engine_output.csv', cleaned_data)

print('Data has been written to "Kolkata_engine_output.csv".')

...
if response.status_code == 200:
    ...
    write_data('C:\Coding Folders\Pyhton_Projects\Pollution_Checker\Delhi\engine_output.csv', cleaned_data)

print('Data has been written to "Delhi_engine_output.csv".')
